...
<div class="page-container">
  ...
  <div class="main-container gray-bg">
		...
		<div class="main-content">
			<h1 class="page-title">Ký túc xá</h1>
		<!-- Breadcrumb -->
      ...
      <span class="sr-only">Next</span>
		...
		<div class="panel-body">
			<div class="col-md-12">
				...
				<div class="col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading no-border clearfix" style="background: #a5eddf"> 
							<h2 class="panel-title"><b>Thông Báo</b></h2>							
						</div> 
						<!-- panel body --> 
						<div class="panel-body">
							<ul class="list-item message-list">
								<li>
									...
									<div class="message-body">
										...
										<h5><font color="blue"> DANH SÁCH VÀ SỐ SỔ ĐĂNG KÝ TẠM TRÚ TẠM VẮNG CỦA SINH VIÊN</font></h5>
										<p>Do yêu cầu và thắc mắc của sinh viên, ban quản lý ký túc xá đăng lại danh sách và số...</p>
									</div>
								</li>
								<li>
									
									<div class="message-body">
										<h5><font color="blue"> TÌNH HÌNH TRIỂN KHAI INTERNET</font></h5>
										<p>1. Đã triển khai hệ thống cáp liên kết xong toà nhà 5...</p>
									</div>
								</li>
								<li>
									
									<div class="message-body">
										<h5><font color="blue"> THÔNG BÁO PHÒNG TRÁNH BÃO SỐ 7</font></h5>
										<p>Theo thông tin dự báo của Đài khí tượng thuỷ văn Trung ương, hồi 19 giờ...</p>
									</div>
								</li>
								<li>
									...
									<div class="message-body">
										<h5><font color="blue"> DANH SÁCH VÀ SỐ SỔ ĐĂNG KÝ TẠM TRÚ TẠM VẮNG CỦA SINH VIÊN</font></h5>
										<p>Do yêu cầu và thắc mắc của sinh viên, ban quản lý ký túc xá đăng lại...</p>
									</div>
								</li>
							</ul>
							<div class="more">
				...
				<div class="col-lg-9">
					<div class="panel panel-default">
						<div class="panel-heading no-border clearfix" style="background: #58FAF4;"> 
							<h2 class="panel-title"><b>Ngày 11/13/2016</b></h2>
				...
				<div class="col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading no-border clearfix" style="background: #81F781"> 
							<h2 class="panel-title"><b>Liên Kết</b></h2>
						</div> 
						<!-- panel body --> 
						<div class="panel-body">
							<ul class="list-item message-list">
								<li>
									<div class="dhbk-icon-link-with-web">
										<img src="images/logobk.jpg" alt="HTML5 icon" width="40">
									</div>
									<div class="header-linked">
										<a href="http://dut.udn.vn" target="_blank">
											<div class="message-body link-with-web">
												<h5><font color="blue"> ĐẠI HỌC BÁCH KHOA</font></h5>
											</div>
											<div class="listbox-content-item-moreinfo">
		                                    	<span class="listbox-content-item-moreinfo-comment date"><span class="glyphicon glyphicon-log-in"></span> http://dut.udn.vn</span>
		                                	</div>
										</a>
									</div>
								...
								<li>
									<div class="dhbk-icon-link-with-web">
										<img src="images/congtacsinhvien.png" alt="HTML5 icon" width="40">
									</div>
									<div class="header-linked">
										<a href="http://ctsv.dut.udn.vn" target="_blank">
											<div class="message-body link-with-web">
												<h5><font color="blue"> CÔNG TÁC SINH VIÊN</font></h5>
											</div>
											<div class="listbox-content-item-moreinfo">
		                                    	<span class="listbox-content-item-moreinfo-comment date"><span class="glyphicon glyphicon-log-in"></span>  http://ctsv.dut.udn.vn</span>
		                                	</div>
										</a>
									</div>
								...
								<li>
									<div class="dhbk-icon-link-with-web">
										<img src="images/community-student-icon.png" alt="HTML5 icon" width="40">
									</div>
									<div class="header-linked">
										<a href=" http://daotao.dut.udn.vn/sv" target="_blank">
											<div class="message-body link-with-web">
												<h5><font color="blue">THÔNG TIN SINH VIÊN</font></h5>
											</div>
											<div class="listbox-content-item-moreinfo">
		                                    	<span class="listbox-content-item-moreinfo-comment date"><span class="glyphicon glyphicon-log-in"></span>  http://daotao.dut.udn.vn/sv</span>
		                                	</div>
										</a>
									</div>
								...
								<li>
									<div class="dhbk-icon-link-with-web">
										<img src="images/books-icon-512.png" alt="HTML5 icon" width="40">
									</div>
									<div class="header-linked">
										<a href=" http://daotao.dut.udn.vn" target="_blank">
											<div class="message-body link-with-web">
												<h5><font color="blue"> THÔNG TIN ĐÀO TẠO</font></h5>
											</div>
											<div class="listbox-content-item-moreinfo">
		                                    	<span class="listbox-content-item-moreinfo-comment date"><span class="glyphicon glyphicon-log-in"></span> http://daotao.dut.udn.vn</span>
		                                	</div>
										</a>
									</div>
